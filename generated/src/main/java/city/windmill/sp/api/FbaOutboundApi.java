...
import city.windmill.sp.ApiCallback;
import city.windmill.sp.ApiClient;
import city.windmill.sp.ApiException;
import city.windmill.sp.ApiResponse;
import city.windmill.sp.Configuration;
import city.windmill.sp.Pair;
import city.windmill.sp.ProgressRequestBody;
import city.windmill.sp.ProgressResponseBody;
import city.windmill.sp.StringUtil;
...
public class FbaOutboundApi {
    ...
    public com.squareup.okhttp.Call cancelFulfillmentOrderCall(String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/fba/outbound/v0/fulfillmentOrders/{sellerFulfillmentOrderId}/cancel"
    ...
    public com.squareup.okhttp.Call createFulfillmentOrderCall(CreateFulfillmentOrderRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/fulfillmentOrders";
    ...
    public com.squareup.okhttp.Call createFulfillmentReturnCall(CreateFulfillmentReturnRequest body, String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/fulfillmentOrders/{sellerFulfillmentOrderId}/return"
            .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", apiClient.escapeString(sellerFulfillmentOrderId.toString()));
    ...
    public com.squareup.okhttp.Call getFulfillmentOrderCall(String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/fulfillmentOrders/{sellerFulfillmentOrderId}"
            .replaceAll("\\{" + "sellerFulfillmentOrderId" + "\\}", apiClient.escapeString(sellerFulfillmentOrderId.toString()));
    ...
    public com.squareup.okhttp.Call getFulfillmentPreviewCall(GetFulfillmentPreviewRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/fulfillmentOrders/preview";
    ...
    public com.squareup.okhttp.Call getPackageTrackingDetailsCall(Integer packageNumber, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/tracking";
     ...
     * @param queryStartDateTime A date and time used to select fulfillment orders that were last updated after (or at) a specified time. An update is defined as any change in fulfillment order status, including the creation of a new fulfillment order. (optional)
     * @param fulfillmentMethod Indicates the intended recipient channel for the order. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listAllFulfillmentOrdersCall(OffsetDateTime queryStartDateTime, List<String> fulfillmentMethod, String nextToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (queryStartDateTime != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("QueryStartDateTime", queryStartDateTime));
        if (fulfillmentMethod != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("csv", "FulfillmentMethod", fulfillmentMethod));
        if (nextToken != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAllFulfillmentOrdersValidateBeforeCall(OffsetDateTime queryStartDateTime, List<String> fulfillmentMethod, String nextToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listAllFulfillmentOrdersCall(queryStartDateTime, fulfillmentMethod, nextToken, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ListAllFulfillmentOrdersResponse listAllFulfillmentOrders(OffsetDateTime queryStartDateTime, List<String> fulfillmentMethod, String nextToken) throws ApiException {
        ApiResponse<ListAllFulfillmentOrdersResponse> resp = listAllFulfillmentOrdersWithHttpInfo(queryStartDateTime, fulfillmentMethod, nextToken);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ListAllFulfillmentOrdersResponse> listAllFulfillmentOrdersWithHttpInfo(OffsetDateTime queryStartDateTime, List<String> fulfillmentMethod, String nextToken) throws ApiException {
        com.squareup.okhttp.Call call = listAllFulfillmentOrdersValidateBeforeCall(queryStartDateTime, fulfillmentMethod, nextToken, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAllFulfillmentOrdersAsync(OffsetDateTime queryStartDateTime, List<String> fulfillmentMethod, String nextToken, final ApiCallback<ListAllFulfillmentOrdersResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAllFulfillmentOrdersValidateBeforeCall(queryStartDateTime, fulfillmentMethod, nextToken, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ListAllFulfillmentOrdersResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    public com.squareup.okhttp.Call listReturnReasonCodesCall(String sellerSKU, String language, String marketplaceId, String sellerFulfillmentOrderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/fba/outbound/v0/returnReasonCodes";
