...
import city.windmill.sp.model.ReturnItem;
 ...
 */
@ApiModel(description = "A list of items that Amazon accepted for return. Returns empty if no items were accepted for return.")
